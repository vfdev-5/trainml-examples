...
num_classes = 21
batch_size = 6 * idist.get_world_size()  # total batch size
...
num_classes = 21
model = deeplabv3_resnet101(num_classes=num_classes, pretrained_backbone=False)
...
lr_scheduler = lrs.LambdaLR(
    optimizer,
    lr_lambda=partial(lambda_lr_scheduler, lr0=lr, n=num_epochs * le, a=0.9)
)
